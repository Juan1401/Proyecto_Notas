...
namespace Proyecto_Notas.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(MerMariaJuliaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Materias != null ? 
                          ...
                          Problem("Entity set 'MerMariaJuliaContext.Materias'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MerMariaJuliaContext.Materias'  is null.");
            }
            var materia = await _context.Materias.FindAsync(id);
            if (materia != null)
            {
